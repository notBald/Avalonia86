...
public static class DialogBox
{
    ...
    public static Task<DialogResult> ShowError(this Window w, string message, Exception err, string header = null, string sub_header = null)
    => Create(w).WithMessage(message).WithHeader(header, sub_header).WithException(err).WithIcon(DialogIcon.Error).ShowDialog();
