...
public static class DialogBox
{
    ...
    public static Task<DialogResult> ShowError(this Window w, string message, Exception err, string header = null)
    => Create(w).WithMessage(message).WithHeader(header).WithException(err).WithIcon(DialogIcon.Error).ShowDialog();
